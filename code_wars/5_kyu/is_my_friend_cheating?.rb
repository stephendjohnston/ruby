...
# empty array (or an empty string) if no possible numbers are found which 
# will prove that my friend has not told the truth! (Go: in this case 
# return nil).
